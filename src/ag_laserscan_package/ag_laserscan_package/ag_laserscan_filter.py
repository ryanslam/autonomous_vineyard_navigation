...
class AgLaserscanFilter(Node):
    ...
    def __init__(self):
        ...
        self.filtered_scan_pub = self.create_publisher(LaserScan, "ag/perception/filtered", 10)
        self.average_scan_pub = self.create_publisher(String, "ag/perception/averaged_scan", 10)
