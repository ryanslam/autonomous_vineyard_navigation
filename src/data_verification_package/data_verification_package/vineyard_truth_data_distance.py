...
class AgTruthDistance(Node):
    ...
    def __init__(self):
        ...
        self.left_distance_pub = self.create_publisher(Int16, '/ag/vineyard/left_distance', 10)
        self.right_distance_pub = self.create_publisher(Int16, '/ag/vineyard/right_distance', 10)
        timer_period = 0.1
    ...
    def timer_callback(self) -> None:
        ...
        print("===============================================")
        print("Distance One: %d\nDistance Two: %d" % (distance_one.data, distance_two.data))
        print("===============================================\n")
