...
def generate_launch_description():
    ...
    host_arg = DeclareLaunchArgument(
        name="host", description="Host name or IP of the sensor."
    )

    ns_arg = DeclareLaunchArgument(
        name="ns", default_value="quanergy", description="Namespace for the node."
    )
    ...
    return LaunchDescription([host_arg, ns_arg, topic_arg, frame_arg, client_node])
