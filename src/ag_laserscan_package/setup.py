...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "ag_laser_dist_orien_calc = ag_laserscan_package.ag_laser_dist_orien_calculation_copy:main",
            "alter_laser_scan = ag_laserscan_package.alter_laser_scan:main",
            "ag_rover_pose=ag_laserscan_package.ag_rover_pose:main",
            "ag_line_fitting = ag_laserscan_package.ag_line_fitting:main",
        ],
    },
)
